        ...
        <div className="flex-1 flex flex-col min-w-0">
          <header className="h-14 flex items-center glass border-b border-border/60 px-4 sticky top-0 z-30">
            ...
            <div className="ml-auto flex items-center gap-3">
              ...
              <div 
                onClick={() => navigate("/recruiter/organization")}
                className="flex h-9 w-9 cursor-pointer items-center justify-center rounded-full bg-gradient-primary text-xs font-semibold text-primary-foreground transition-transform hover:scale-110 active:scale-95"
              >
                R
              </div>
            </div>
